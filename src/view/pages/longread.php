<div>
  <svg class="line line--intro" xmlns="http://www.w3.org/2000/svg" width="1204.203" height="876.468" viewBox="0 0 1204.203 876.468" preserveAspectRatio="none">
      <path class="path" id="Path_1" data-name="Path 1"
  ...
  <section class="history container--small">
    ...
    <ul class="history__examples">
      ...
      <li>
        ...
        <p>Tijdens de Tweede Wereldoorlog werden veel bibliotheken verwoest, onder andere die van de Universiteit Leuven.</p>
      </li>
    </ul>
  </section>
